...
exceptdatas = ["threads-ask-ubuntu", "coauth-MAG-Geology-full", "coauth-MAG-History-full"]
num = 300

def find_svs(dataname, inputpath, outputdir, recalculate_flag):
    ...
    s = -1
    flag = True
    if (recalculate_flag is False) and (os.path.isfile(outputpath)): # Read Singular Values
        s = []
...
if __name__ == "__main__":
    ...
    for dataname in dataset:
        ...
        answer_s, answer_dim = find_svs(dataname, inputpath, outputdir, args.recalculate)
        if answer_s == -1:
            continue
            ...
            for sampled_algo in tqdm(sampled_algo_list, desc=dataname + " " + portion_str):
                 for repeat_str in repeat_list:
                    ...
                    if os.path.isfile(inputpath) is False:
                        ...
                        sampled_s, sampled_dim = find_svs(dataname, inputpath, outputdir, args.recalculate)
